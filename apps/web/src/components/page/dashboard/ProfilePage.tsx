...
export default function ProfilePage({ user }: Props) {
  ...
  const handleTopUp = () => {
    // placeholder: open modal / call API to top-up
    // For demo we simply increment wallet by 100
    setWallet((w) => w + 100);
  };
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <div className="p-4 bg-white border rounded-lg shadow-sm flex items-center justify-between">
              ...
              <div className="flex flex-col gap-2">
                <button
                  onClick={handleTopUp}
                  className="px-3 py-2 bg-cyan-600 text-white rounded-md hover:bg-cyan-700 text-sm"
                >
                  Top Up
                </button>
